...
import { 
  ClipboardList, Factory, ShieldCheck, AlertTriangle, 
  Truck, Package, TrendingUp, DollarSign, Users 
} from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        {isSuperAdmin ? (
          <>
            <StatsCard title="Revenue Forecast" value="Rp 450M" icon={DollarSign} variant="mint" trend={{ value: 12, positive: true }} delay={0} />
            <StatsCard title="Total Users" value={24} icon={Users} variant="default" subtitle="6 Divisi Aktif" delay={0.1} />
            <StatsCard title="Global Efficiency" value="94.2%" icon={TrendingUp} variant="mint" trend={{ value: 2.1, positive: true }} delay={0.2} />
            <StatsCard title="Stock Alerts" value={3} icon={AlertTriangle} variant="orange" subtitle="Perlu Restock" delay={0.3} />
          </>
        ) : (
          <>
